  ...
  return (
    <div className="app-viewport flex justify-center bg-surface-2 lg:py-8">
      <div className="relative flex h-full w-full max-w-[430px] flex-col overflow-hidden bg-background lg:h-[calc(100dvh-4rem)] lg:rounded-[2.75rem] lg:shadow-[0_32px_64px_-24px_rgba(14,21,18,0.18)]">
        {header ?? (
          <header className="pt-safe shrink-0 bg-background px-6 pt-4">
            <div className="flex items-start justify-between gap-3">
              <div className="min-w-0 pt-1">
                <h1 className="font-display truncate text-[27px] font-semibold">
                  {title}
                </h1>
                {subtitle && (
              ...
              {showProfile && (
                <div className="flex shrink-0 items-center gap-2">
                  ...
                  <span
                    className="flex size-10 items-center justify-center rounded-full text-[11px] font-bold text-primary-foreground ring-2 ring-background"
